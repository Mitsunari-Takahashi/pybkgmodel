...
# sigma_tail, gamma_tail, ecc_tail0, delta_ecc_tail, phi_tail: King
#   function tail (extended halo component), fixed at the camera
#   center; ecc_tail0/delta_ecc_tail set its energy-dependent
#   eccentricity.
...
def default_camera_response_guess(bkg_map):
    ...
    gamma_tail0 = 2.0
    # Kept strictly away from 0/1: ecc_tail's logit-space energy
    # dependence (see camera_response()) is undefined exactly at the
    # boundary and has a vanishing gradient near it.
    ecc_tail0 = 0.1
    delta_ecc_tail0 = 0.0
    phi_tail0 = 0.0
    ...
    p0 = [
        ...
        sigma_tail0, gamma_tail0, ecc_tail0, delta_ecc_tail0, phi_tail0,
        w0, delta_w0,
